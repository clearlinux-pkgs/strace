...
Source0  : https://github.com/strace/strace/releases/download/v6.11/strace-6.11.tar.xz
Source1  : https://github.com/strace/strace/releases/download/v6.11/strace-6.11.tar.xz.asc
...
%setup -q -n strace-6.11
cd %{_builddir}/strace-6.11
pushd ..
cp -a strace-6.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726523708
