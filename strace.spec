...
Source0  : https://github.com/strace/strace/releases/download/v6.7/strace-6.7.tar.xz
Source1  : https://github.com/strace/strace/releases/download/v6.7/strace-6.7.tar.xz.asc
...
%prep
%setup -q -n strace-6.7
cd %{_builddir}/strace-6.7
pushd ..
cp -a strace-6.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706561091
