...
Source0  : https://github.com/strace/strace/releases/download/v6.5/strace-6.5.tar.xz
Source1  : https://github.com/strace/strace/releases/download/v6.5/strace-6.5.tar.xz.asc
...
%prep
%setup -q -n strace-6.5
cd %{_builddir}/strace-6.5
pushd ..
cp -a strace-6.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1693938786
