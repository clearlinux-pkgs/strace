...
Source0  : https://github.com/strace/strace/releases/download/v6.13/strace-6.13.tar.xz
Source1  : https://github.com/strace/strace/releases/download/v6.13/strace-6.13.tar.xz.asc
...
%setup -q -n strace-6.13
cd %{_builddir}/strace-6.13
pushd ..
cp -a strace-6.13 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737639165
