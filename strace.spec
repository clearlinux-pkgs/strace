...
Source0  : https://github.com/strace/strace/releases/download/v6.14/strace-6.14.tar.xz
Source1  : https://github.com/strace/strace/releases/download/v6.14/strace-6.14.tar.xz.asc
...
%setup -q -n strace-6.14
cd %{_builddir}/strace-6.14
pushd ..
cp -a strace-6.14 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742914667
