...
Source0  : https://github.com/strace/strace/releases/download/v5.17/strace-5.17.tar.xz
Source1  : https://github.com/strace/strace/releases/download/v5.17/strace-5.17.tar.xz.asc
...
%prep
%setup -q -n strace-5.17
cd %{_builddir}/strace-5.17
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648436371
...
cp %{_builddir}/strace-5.17/COPYING %{buildroot}/usr/share/package-licenses/strace/5e5aac2444f406ba1f796ceff6887fc3b1def247
cp %{_builddir}/strace-5.17/bundled/linux/COPYING %{buildroot}/usr/share/package-licenses/strace/3f9f7be18936296d848182000ba3a63a240e0db1
cp %{_builddir}/strace-5.17/debian/copyright %{buildroot}/usr/share/package-licenses/strace/d3cbcf91f3a68d195eb9a558d54fd07c55f4faea
cp %{_builddir}/strace-5.17/tests-m32/COPYING %{buildroot}/usr/share/package-licenses/strace/c25e42893e9414a57ab2948804b87f37b1ee8c1a
cp %{_builddir}/strace-5.17/tests-mx32/COPYING %{buildroot}/usr/share/package-licenses/strace/c25e42893e9414a57ab2948804b87f37b1ee8c1a
cp %{_builddir}/strace-5.17/tests/COPYING %{buildroot}/usr/share/package-licenses/strace/c25e42893e9414a57ab2948804b87f37b1ee8c1a
%make_install
