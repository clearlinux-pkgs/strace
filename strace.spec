...
Source0  : https://github.com/strace/strace/releases/download/v6.15/strace-6.15.tar.xz
Source1  : https://github.com/strace/strace/releases/download/v6.15/strace-6.15.tar.xz.asc
...
%setup -q -n strace-6.15
cd %{_builddir}/strace-6.15
pushd ..
cp -a strace-6.15 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748356007
