...
Source0  : https://github.com/strace/strace/releases/download/v6.9/strace-6.9.tar.xz
Source1  : https://github.com/strace/strace/releases/download/v6.9/strace-6.9.tar.xz.asc
...
%setup -q -n strace-6.9
cd %{_builddir}/strace-6.9
pushd ..
cp -a strace-6.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715729397
