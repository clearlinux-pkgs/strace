...
Source0  : https://github.com/strace/strace/releases/download/v6.12/strace-6.12.tar.xz
Source1  : https://github.com/strace/strace/releases/download/v6.12/strace-6.12.tar.xz.asc
...
%setup -q -n strace-6.12
cd %{_builddir}/strace-6.12
pushd ..
cp -a strace-6.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731955230
